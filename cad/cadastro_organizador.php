...
if(isset($_POST['grava'])){
  ...
  $rua=$_POST['rua'];
  $numero=$_POST['numero'];
  $grava=$conn->prepare('INSERT INTO `organizadores` (`id_organizador`, `nm_organizador`, `ds_email`, `ds_senha`, `dt_nascimento`, 
  `nr_telefone`, `nr_cnpj`, `nr_cep`, `nm_estado`, `nm_cidade`, `nm_rua`, `ds_numero`, `nm_bairro`, `ds_status_cad`) 
  VALUES (NULL, :nome, :email, :senha, :datanasc, :telefone, :cnpj, :cep, :estado, :cidade, :rua, :numero, :bairro, 1);');
  ...
  $grava->execute();
  header("Location: login_organizador.php");
}
?>
   ...
   <br>  
    <div class="row">
      ...
      <div class="col-6" style="border-width: 2px; border-style: solid; border-color: #E0E6EB; border-radius: 10px; background-color: #fff;">
        <form action="cadastro_organizador.php" method="POST">
          ...
          <div class="form-floating mb-3">
            <input type="text" name="cnpj" class="form-control" id="floatingInput" placeholder="name@example.com">
