...
if (isset($_GET['exclusao'])) {
   ...
   $excluir = $conn->prepare("UPDATE `organizadores` SET `ds_status_cad` = '0' WHERE `id_organizador` = :id_organizador;");
   $excluir->bindValue(":id_organizador", $id_organizador);
   $excluir->execute();
...
if (isset($_GET['ativar'])) {
   $id_organizador = $_GET['id'];
   $excluir = $conn->prepare("UPDATE `organizadores` SET `ds_status_cad` = '1' WHERE `id_organizador` = :id_organizador;");
   $excluir->bindValue(":id_organizador", $id_organizador);
   $excluir->execute();
   header("Location: organizadores.php");
   exit();
...
<body>
   ...
   <?php
   $exib = $conn->prepare("SELECT * FROM organizadores");
   $exib->execute();
               ...
               <table class="table table-striped table-hover table-borderless table-sm">
                  ...
                  <tbody>
                     <?php foreach ($resultados as $resultado) : ?>
                        <tr>
                           <th scope="row"><?php echo htmlspecialchars($resultado['id_organizador']); ?></th>
                           <td><?php echo htmlspecialchars($resultado['nm_organizador']); ?></td>
                           <td><?php echo htmlspecialchars($resultado['nr_cnpj']); ?></td>
                           ...
                           <td>
                              <a href="#" class="link-dark link-underline" data-bs-toggle="modal" data-bs-target="#excluir_<?php echo $resultado['id_organizador']; ?>">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                                    <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5m-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5M4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06m6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528M8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5" />
                                 </svg>
                              </a>
                              <!-- Modal de exclusão -->
                              <div class="modal fade" id="excluir_<?php echo $resultado['id_organizador']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                 <div class="modal-dialog">
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          Tem certeza que deseja excluir o organizador <?php echo $resultado['nm_organizador']; ?>?
                                       </div>
                                       <div class="modal-footer">
                                          <a href="organizadores.php?exclusao&id=<?php echo $resultado['id_organizador']; ?>" class="btn btn-danger">Sim</a>
                           ...
                           <td>
                              <a href="#" class="link-dark link-underline" data-bs-toggle="modal" data-bs-target="#ativar_<?php echo $resultado['id_organizador']; ?>">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2" viewBox="0 0 16 16">
                                    <path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0" />
                                 </svg>
                              </a>
                              <!-- Modal de ativação -->
                              <div class="modal fade" id="ativar_<?php echo $resultado['id_organizador']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                 <div class="modal-dialog">
                                    <div class="modal-content">
                                       <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLabel">Confirmar Ativação</h5>
                                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                       </div>
                                       <div class="modal-body">
                                          Tem certeza que deseja ativar o organizador <?php echo $resultado['nm_organizador']; ?>?
                                       </div>
                                       <div class="modal-footer">
                                          <a href="organizadores.php?ativar&id=<?php echo $resultado['id_organizador']; ?>" class="btn btn-success">Sim</a>
                                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Não</button>
                                       </div>
                                    </div>
                                 </div>
